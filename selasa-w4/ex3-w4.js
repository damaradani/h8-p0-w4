//Exercise 3 week 4 Logic Challenge - Mencari Median
/*Problem:
...
Contoh, median atau dari [1, 2, 3, 4, 5] adalah 3 yang merupakan nilai
yang ada di posisi tengah dari deret tersebut.
...
function cariMedian(arr) {
  ...
  if(arr.length % 2 !== 0){
    ...
    var midNum = arr[arr.length / 2] + arr[arr.length / 2 -1];
    return midNum / 2;
  }
